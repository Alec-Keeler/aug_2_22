...
require('dotenv').config(); //accesssing the variables in .env file
require('express-async-errors');


// Import the models used in these routes - DO NOT MODIFY
const { Cat, Toy, sequelize } = require('./db/models');
//importing the models and sequelize into app.js
const { Op } = require("sequelize");
//setting up Op for operations in our queries
...
app.get('/cats/:id/toys', async (req, res, next) => {
    ...
    console.log('added keys', catData)
